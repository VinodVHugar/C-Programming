...
void column_sum_highest(int num[ROW][COL], int r, int c);
...
void column_sum_highest(int num[ROW][COL], int r, int c)
{
 ...
 printf("\nHighest in column wise sum is %d\n",high);
}
int diagonal_sum(int num[ROW][COL], int r, int c)
{
 int i,j,dsum=0;
